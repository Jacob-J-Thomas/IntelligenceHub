...
namespace IntelligenceHub.Business.Handlers
{
    public class ValidationHandler : IValidationHandler
    {
        ...
        {
            if (profile.Model != null && _validModels.Contains(profile.Model) == false) return "The model name must match and existing AI model";
            ...
            if (profile.Max_Tokens < 1 || profile.Max_Tokens > 1000000) return "Max_Tokens must be a value between 1 and 1,000,000";
