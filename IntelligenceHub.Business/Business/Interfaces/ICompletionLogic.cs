...
namespace IntelligenceHub.Business.Interfaces
{
    public interface ICompletionLogic
    {
        ...
        Task<List<HttpResponseMessage>> ExecuteTools(Dictionary<string, string> toolCalls, List<Message> messages, Profile? options = null, Guid? conversationId = null, bool streaming = false, int currentRecursionDepth = 0);
    }
}
